    ...
    map<string, vector<vector<Question>>> questionBank = {
        ...
        {"Python", {
            ...
            { // Python Quiz 2 (Intermediate)
                ...
                {"14. What is the purpose of 'init' in a class?", {" It is a destructor", " It initializes objects", " It is a static method", " It deletes objects"}, 'B'},
            ...
            { // Python Quiz 3 (Advanced)
                ...
                {"6. What does 'call' do?", {" Calls an object", " Creates an instance", " Calls a function", " None of the above"}, 'A'},
